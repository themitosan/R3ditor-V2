...
const R3_internalHoldTime = 2800,
	...
	*/
	R3_HC_DATABASE = {
		...
		*/
		4: ['Help Center Main Menu', '<div class="align-center"><br><img ondragstart="return false;" src="img/icons/icon-53.png" class="R3_HC_fnIcon" title="Help Center"><br>Hello and welcome to R3ditor V2 Help Center!<br>Here you can learn more about how this tool works and the tips for best usage!</div><br>' +
									 // Initial Info
									 ...
									 // Backup Manager
									 '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-backup.png" class="R3_HC_fnIcon" title="Backup Manager"><br><font class="LBL_subTitle">Backup Manager</font></div><br>' +
									 ...
									 'you did it.<br>It\'s a matter of looking and you will know how to use it!<br><br><div class="align-center"><img ondragstart="return false;" src="img/HC/HC_SCD_IMG_2.png" class="R3_HC_IMG"></div><br>' +
		...
		*/
		9: ['SCD Editor', '<br>Also known as <b>S</b>cript <b>C</b>ode <b>D</b>ata, this is where you will edit all events that happens on current map. Here you can set variables, items, create cutscenes, spawn NPCS (or enemies) and much more.<br>' +
						  ...
						  // Editing modes
						  '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-49.png" class="R3_HC_fnIcon" title="List Mode"> <img ondragstart="return false;" src="img/icons/icon-48.png" class="R3_HC_fnIcon" title="Code Mode"><br><font class="LBL_subTitle">Editing modes (Code & List Modes)</font></div><br>There is two editing modes that you can use to create your scripts. ' +
						  ...
						  // Edit mode: List mode
						  '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-49.png" class="R3_HC_fnIcon" title="List Mode"><br><font class="LBL_chapter">List Mode</font><br><br><img ondragstart="return false;" src="img/HC/HC_SCD_IMG_0.png" class="R3_HC_IMG" title="This is a example of how an RPG Maker MV script looks like."></div><br>The picture above shows how an ' + 
						  ...
						  // Insert Hex
						  '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-42.png" class="R3_HC_fnIcon" title="Insert Hex"><br><font class="LBL_subTitle">Insert Hex</font></div><br>With this feature, you can insert hex functions directly on your script. To make that, ' +
						  ...
						  // Code Preset
						  '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-45.png" class="R3_HC_fnIcon" title="Code Preset"><br><font class="LBL_subTitle">Code Preset</font></div><br>With this section, you can use pre-built functions to speed-up your script creation process!<br>To use it, open the mini-window and' +
		...
		*/
		10: ['RDT Editor', '<br>Also known as <b>R</b>oom <b>D</b>ata<b>T</b>able, RDT is the file that holds all data about a room, with all items, doors, events and so much more. On this section, you can open a specific editor to modify some aspects of this location - like ' +
						   ...
						   // Export Sections 
						   '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-51.png" class="R3_HC_fnIcon"><br><font class="LBL_subTitle">Export Sections</font></div><br>You can export all sections individually by using export button.<br>It will open a new popup ' +
						   'with a list with all available sections to extract.<br><br>' +
						   // SCD Hack
						   '<div class="align-center"><img ondragstart="return false;" src="img/icons/icon-enable-hack.png" class="R3_HC_fnIcon" title="Install SCD Hack"> <img ondragstart="return false;" src="img/icons/icon-hack.png" class="R3_HC_fnIcon" title="Apply SCD Hack"><br><font class="LBL_subTitle">SCD Hack</font></div><br>' + 
	...
	*/
	R3_DESIGN_DROPDOWN_DATABASE = {
		...
		10: ['RDT Options', '<div class="R3_MENU_ITEM_NORMAL" title="Click here to Extract all RDT sections (Like BIOFAT)" onclick="R3_RDT.sections.exportAll();">Extract all sections</div>' +
							...
							'<div class="R3_MENU_ITEM_BIG" title="Click here to open export window" onclick="R3_MINIWINDOW.open(10);"><img ondragstart="return false;" class="R3_MENU_ICON" src="img/icons/icon-51.png"><div class="R3_MENU_BIG_LBL">Export Sections Menu</div></div>' +
