...
const R3_internalHoldTime = 2800,
	...
	*/
	R3_SCD_DATABASE = {
		...
		'61': [32, 'Set Door [DOOR_AOT_SET]', 		   		 1,  true,  'DOOR_AOT_SET', 			false, 726, 480,  true],
		'62': [40, 'Set Door 4P [DOOR_AOT_SET_4P]',    		 1,  true,  'DOOR_AOT_SET_4P',			false, 726, 502,  true],
