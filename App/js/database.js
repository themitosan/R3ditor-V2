...
const 
	...
	INCLUDE_ENDING = '<br><u>Special Thanks To:</u><br><br><u><a target="_blank" href="https://www.ct-stars.com/">The Entire CT-STARS Team! (Special Mention to <font title="Thanks, Master!">Flag-King</font>!)</a></u><br>' +
					 '<u><a target="_blank" href="https://twitter.com/khaleed681">Khaled SA</a> - for teaching me several RE3 tricks!</u><br>' +
	...
	INCLUDE_RDT_FILELIST_GAMEMODE = '<option value="DATA_AJ">Easy Mode (DATA_AJ)</option><option value="DATA_E">Hard Mode (DATA_E)</option><option value="DATA_J">Hard Mode (DATA_J)</option>',
	// SCD Script Names
	SCD_scriptNames = {
		0: 'INIT',
		1: 'AutoExec'
	...
	*/
	...
	R3_SCD_AOT_TYPES = {
		...
		'05': ['Script Page (Event)', 'Data 0', 'Data 1', 'Data 2', 'Script Page'],
