...
const gte = {
  ...
  updateColorFifo: function() {
    ...
    const c = this.rgb[3] >>> 24,
          r = this.lim((mac[1] / 16.0), 0.0, 21, 255.0, 21),
          g = this.lim((mac[2] / 16.0), 0.0, 20, 255.0, 20),
          b = this.lim((mac[3] / 16.0), 0.0, 19, 255.0, 19);
