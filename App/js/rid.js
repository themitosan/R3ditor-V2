...
function R3_RID_recompile(){
	if (RID_arquivoBruto !== undefined){
		var c = 0, tempHex = '', cCam = RID_currentCamera,
			RID_type = document.getElementById('R3_RID_EDIT_camType').value,
			RID_unk0 = MEMORY_JS_fixVars(document.getElementById('R3_RID_EDIT_unk0').value, 4),
			RID_X	 = R3_parseEndian(R3_convertPosNumbersToHex(parseInt(document.getElementById('R3_RID_EDIT_posX').value))),
			RID_Y	 = R3_parseEndian(R3_convertPosNumbersToHex(parseInt(document.getElementById('R3_RID_EDIT_posY').value))),
			RID_Z	 = R3_parseEndian(R3_convertPosNumbersToHex(parseInt(document.getElementById('R3_RID_EDIT_posZ').value))),
			RID_R	 = R3_parseEndian(R3_convertPosNumbersToHex(parseInt(document.getElementById('R3_RID_EDIT_posR').value))),
